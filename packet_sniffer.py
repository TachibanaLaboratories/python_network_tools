...
class TCPStream():
    ...
    def __init__(self, stack_timeout):
        ...
        if not stack_timeout == None:
            ...
            self._tcp_stack timeout = 0 ## how long/ how many operations until stream is popped off stack, default is never
...
class PacketSniffer():
    def __init__(self, packet, target, *args):
    ...
    def sniff(self):
        scapy.sniff("eth0", store=False, prn=get_protocol_data)
